...
import {Image, Text, View, Animated, StyleSheet, Modal, Button} from 'react-native';
...
function NfcPromptAndroid() {
  ...
  const [_data, _setData] = useOutlet<any>('androidPrompt');
    ...
    <Modal transparent={true} visible={visible}>
      <View style={[styles.wrapper]}>
        ...
        <Animated.View style={[styles.prompt, promptAnimStyle]}>
          ...
          <Button title='CANCEL' onPress={cancelNfcScan} />
        </Animated.View>
